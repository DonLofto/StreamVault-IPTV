    ...
    if (uiState.providers.isEmpty()) {
        ...
        item {
            ...
            ProviderSettingsCard(
                ...
                isRunningDatabaseMaintenance = uiState.isRunningDatabaseMaintenance,
                isRunningTvInputSync = uiState.isRunningTvInputSync,
                onRunDatabaseMaintenance = viewModel::runDatabaseMaintenance,
                onSyncTvInputChannels = viewModel::syncTvInputChannels,
